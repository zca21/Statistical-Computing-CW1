...
#The answer of the log joint pdf of each inputted x value is -0.592 -1.211 -3.644 -0.023 -1.215 -1.166 -1.792 -1.267 -1.148 -1.869 respectively (to 3 d.p.)
```
...
dgamma(c(2,3,4),2,5)
#Note that density returns a vector of values if x is a vector
```
...
calcMidRiemann(xVec,2.1,0.5,3,6,2)
